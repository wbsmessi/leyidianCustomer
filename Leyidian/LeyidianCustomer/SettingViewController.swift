...
//        [[NSBundle mainBundle] objectForInfoDictionaryKey:@"CFBundleShortVersionString"];
        ...
        table.frame = CGRect(x: 0, y: 80, width: app_width, height: 45 * 6 + 15)
        table.bounces = false
        table.delegate = self
        ...
        method.creatButton(btn: signOut, x: 15, y: table.bottomPosition() + 30, wid: app_width - 30, hei: 45, title: "退出登录", titlecolor: UIColor.white, titleFont: 16, bgColor: UIColor.clear, superView: self.view)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell{
        ...
        let title = UILabel()
        method.creatLabel(lab: title, x: img.rightPosition() + 15, y: 0, wid: 150, hei: 45, textString: titleArr[indexPath.section][indexPath.row], textcolor: UIColor.black, textFont: 12, superView: cell.contentView)
