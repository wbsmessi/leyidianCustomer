...
extension UIResponder {
    ...
    // new apis from v3.3
    func noticeSuccess(_ text: String, autoClear: Bool = false, autoClearTime: Int = 1) {
    ...
    func noticeError(_ text: String, autoClear: Bool = false, autoClearTime: Int = 1) {
    ...
    func noticeInfo(_ text: String, autoClear: Bool = false, autoClearTime: Int = 1) {
    ...
    func notice(_ text: String, type: NoticeType, autoClear: Bool, autoClearTime: Int = 1) {
...
class SwiftNotice: NSObject {
    ...
    static func showNoticeWithText(_ type: NoticeType,text: String, autoClear: Bool, autoClearTime: Int) {
        ...
        checkmarkView.frame = CGRect(x: frame.width/2-18, y: (frame.height-40)/2 - 18, width: 36, height: 36)
        mainView.addSubview(checkmarkView)
        
        let label = UILabel(frame: CGRect(x: 0, y: 110, width: 150, height: 30))
        label.font = UIFont.systemFont(ofSize: 12)
        label.textColor = UIColor.white
